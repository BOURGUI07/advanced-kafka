package com.example.cloud_stream_kafka_playground.sec05.producer;

import com.example.cloud_stream_kafka_playground.sec05.dto.OrderEvent;
import com.example.cloud_stream_kafka_playground.sec05.dto.OrderType;
...
public class OrderEventProducerConfig {
    ...
    private Message<OrderEvent> toMessage(int i){
        ...
        var order = new OrderEvent(i,i,type);
